  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-24 space-y-24">
      <section className="text-center max-w-3xl mx-auto space-y-8">
        <h1 className="text-5xl font-bold font-headline">Bridging the Gap Between <br/><span className="text-neon-blue">College</span> and <span className="text-neon-purple">Career</span></h1>
        <p className="text-xl text-muted-foreground leading-relaxed">
          PrepStack AI was born out of a simple need: to provide students with the structured, industry-relevant preparation they need to crack dream placements confidently.
        </p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="glass-card p-12 rounded-3xl space-y-6 border-primary/20">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            To empower students with structured guidance, AI-powered insights, and industry-ready preparation strategies. We believe every student deserves a clear path to their dream career, regardless of their background.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                With a background in software engineering and a passion for education, Somnath developed PrepStack to automate the personalized guidance he was giving to his juniors, making quality placement prep accessible to all.
              </p>
            </div>
